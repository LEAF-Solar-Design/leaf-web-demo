...
//
// This test uses an expected failure for the known error signal. ToolCast.jsx
...
// test marks only the known banner assertion as expected to fail. The suite
...
test('the deployed staging /try surface loads without an HTTP-level or application error', async ({ page }) => {
  ...
  test.fail(true, 'Known UX gap: anonymous healthy staging renders the operator banner as Request failed.')
