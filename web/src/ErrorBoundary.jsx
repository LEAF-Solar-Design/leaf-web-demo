  ...
  render() {
    ...
    return (
      <div style={WRAP} role="alert">
        <div style={CARD}>
          <div style={DIAMOND} />
          {/* The heading states WHAT HAPPENED; the action is the button below
              it. A heading that ends in the same imperative reads as a
              truncated sentence and says the instruction twice. */}
