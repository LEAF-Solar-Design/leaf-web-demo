 ...
 *     ribbon/command skeleton (OpenCADStudio interaction model, LEAF-native
...
describe('acceptance: renders the ribbon/command skeleton (OpenCADStudio interaction model, LEAF-native implementation)', () => {
