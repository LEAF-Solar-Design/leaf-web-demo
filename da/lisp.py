...
MUTATION_INSPECT_BLOCKS += (
    ...
    '(progn (setq f (open "{OUT}" "a") gr-dict (dictsearch (namedobjdict) "ACAD_GROUP")) (if gr-dict (progn (setq gr-e (cdr (assoc -1 gr-dict)) gr-owner (cdr (assoc 5 (entget gr-e))) gr-name nil) (foreach gr-pair (entget gr-e) (cond ((= (car gr-pair) 3) (setq gr-name (cdr gr-pair))) ((and gr-name (member (car gr-pair) (list 350 360))) (leaf-gr-row gr-name (cdr gr-pair) gr-owner) (setq gr-name nil)))))) (close f))',
