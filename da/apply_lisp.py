...
_GROUP_LISP_LINES = (
    ...
    '(defun leaf-group-name-p (s / i ok c) (setq i 1 ok (and (> (strlen s) 0) (<= (strlen s) 255) (/= (substr s 1 1) "*"))) (while (and ok (<= i (strlen s))) (setq c (ascii (substr s i 1))) (if (or (< c 32) (> c 126) (member c (list 60 62 47 92 34 58 59 63 42 124 44 61 96))) (setq ok nil)) (setq i (1+ i))) ok)',
