...
_RUN_TOOL_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {"tool": {"type": "string"}, "params": {"type": "object"},
                   ...
                   "drawing_version": {"type": "integer"},
                   "expected_drawing_head": {"type": "integer"},
                   "catalog_commit": {"type": "string"},
                   "effective_catalog_digest": {"type": "string"},
                   "tool_manifest_sha256": {"type": "string"},
    ...
    "actions": {
        ...
        "request_publication": {
            ...
            "args_schema": {"type": "object",
                            ...
                            "required": ["change_set_id"], "additionalProperties": False},
            "rate_limit_category": "high", "timeout_s": 120,
            "audit_extra": ["change_set_id"],
        },
        "register_tool": {
            ...
            "args_schema": {"type": "object",
                            "properties": {
                                ...
                                "staged_commit": {"type": "string"},
                                "catalog_digest": {"type": "string"},
                                "platform_release": {"type": "string"},
                                "workspace_contract_digest": {"type": "string"},
                                "confirmation_id": {"type": "string"},
                                "idempotency_key": {"type": "string"},
                            },
                            "required": ["change_set_id", "staged_commit", "catalog_digest",
                                         "platform_release", "workspace_contract_digest",
                                         "idempotency_key"],
                            "additionalProperties": False},
            "rate_limit_category": "high", "timeout_s": 120,
            "audit_extra": ["change_set_id", "catalog_digest"],
        },
        "customize_platform": {
            ...
            "policy": "always-confirm", "tenant_tightenable": False,
            "dispatch": {"kind": "app_api",
                         "routes": ["POST /api/platform/customize",
        ...
        "propose_overlay": {
            ...
            "rung": 2, "required_capability": "converse",
            "policy": "auto", "tenant_tightenable": True,
            "dispatch": {"kind": "app_api",
                         "routes": ["POST /api/overlay/proposals"]},
            "args_schema": {"type": "object",
                            "properties": {
                                "tokens": {"type": "object",
                            ...
                            "required": ["tokens"],
                            "additionalProperties": False},
            "rate_limit_category": "medium", "timeout_s": 20,
            "audit_extra": ["request_text"],
        },
        "finish_project": {
            ...
            "rung": 2, "required_capability": "converse", "policy": "auto",
            "tenant_tightenable": True,
            "dispatch": {"kind": "app_api",
                         "routes": ["POST /api/campaigns/conversation/finish"]},
            "args_schema": {"type": "object",
                            "properties": {
                                "title": {"type": "string"},
                                "prompt": {"type": "string"},
                            ...
                            "required": ["title", "prompt", "delivery_profile", "intended_user",
                                         "workflow", "artifact_refs"],
                            "additionalProperties": False},
            "rate_limit_category": "medium", "timeout_s": 30,
            "audit_extra": ["delivery_profile"],
        },
    },
    "tier_overrides": {},
}
