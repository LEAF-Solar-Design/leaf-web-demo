...
def build_suites() -> List[Suite]:
    ...
    suites: List[Suite] = [
        ...
        # exact collected count on every runner: 25 (11 + three zone-assign, three frame-park, four W4, two sizer and two platform cases,
        # G36 addendum),
        # 10 + 5 parametrizations = 15, 8 + 8 = 16.
        Suite("server-solar-batch2-simple", "server tests/test_solar_batch2_simple.py",
              "pytest", SERVER, _py_pytest("tests/test_solar_batch2_simple.py"), 25),
        ...
        # the file, so each floor is the exact collected count: 10 (with z2, z3, f2, m1, o1, k1 and p1), 5 and 3.
        Suite("scripts-solar-batch2-simple-evidence", "scripts test_solar_batch2_simple_evidence.py",
              "pytest", SCRIPTS_DIR, _py_pytest("test_solar_batch2_simple_evidence.py"), 10),
