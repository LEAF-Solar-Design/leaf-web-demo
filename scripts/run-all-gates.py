...
def build_suites() -> List[Suite]:
    ...
    suites: List[Suite] = [
        ...
        # exact collected count on every runner: 32 (11 + three zone-assign, three frame-park, four W4, nine sizer and two platform cases,
        # G36 addendum),
        ...
        Suite("server-w1-solve-split", "server tests/test_w1_solve_split.py", "pytest", SERVER,
        ...
        Suite("server-broker-admission-reconciler", "server tests/test_broker_admission_reconciler.py", "pytest", SERVER,
              _py_pytest("tests/test_broker_admission_reconciler.py"), 54),
        ...
        Suite("server-w4g7c-03s", "server tests/test_w4g7c_03s.py", "pytest", SERVER,
              _py_pytest("tests/test_w4g7c_03s.py"), 37),
        ...
        # the file or committed intakes, so each floor is the exact collected count: 12 (including two k2 cases), 5 and 3.
        Suite("scripts-solar-batch2-simple-evidence", "scripts test_solar_batch2_simple_evidence.py",
              "pytest", SCRIPTS_DIR, _py_pytest("test_solar_batch2_simple_evidence.py"), 12),
        ...
        Suite("build-platform-images-workflow",
              ...
              _py_pytest("test_build_platform_images_workflow.py"), 53),
        ...
        # #213: server test files registered from the measured sweep; floors are the passed counts of each file run alone.
        Suite("server-annotation-routes", "server tests/test_annotation_routes.py", "pytest", SERVER,
              _py_pytest("tests/test_annotation_routes.py"), 19),
        Suite("server-annotation-source-authority", "server tests/test_annotation_source_authority.py", "pytest", SERVER,
              _py_pytest("tests/test_annotation_source_authority.py"), 25),
        Suite("server-app-conversation-routes", "server tests/test_app_conversation_routes.py", "pytest", SERVER,
              _py_pytest("tests/test_app_conversation_routes.py"), 1),
        Suite("server-approval-policy", "server tests/test_approval_policy.py", "pytest", SERVER,
              _py_pytest("tests/test_approval_policy.py"), 30),
        Suite("server-arlo-lab-inputs", "server tests/test_arlo_lab_inputs.py", "pytest", SERVER,
              _py_pytest("tests/test_arlo_lab_inputs.py"), 23),
        Suite("server-arlo-review", "server tests/test_arlo_review.py", "pytest", SERVER,
              _py_pytest("tests/test_arlo_review.py"), 20),
        Suite("server-author-live-harness", "server tests/test_author_live_harness.py", "pytest", SERVER,
              _py_pytest("tests/test_author_live_harness.py"), 1),
        Suite("server-broker-blank-dwg", "server tests/test_broker_blank_dwg.py", "pytest", SERVER,
              _py_pytest("tests/test_broker_blank_dwg.py"), 18),
        Suite("server-build-queue", "server tests/test_build_queue.py", "pytest", SERVER,
        ...
        Suite("server-cad-upload-disposition", "server tests/test_cad_upload_disposition.py", "pytest", SERVER,
              _py_pytest("tests/test_cad_upload_disposition.py"), 4),
        Suite("server-cad-upload-e2e", "server tests/test_cad_upload_e2e.py", "pytest", SERVER,
              _py_pytest("tests/test_cad_upload_e2e.py"), 3),
        Suite("server-cad-upload-validation", "server tests/test_cad_upload_validation.py", "pytest", SERVER,
              _py_pytest("tests/test_cad_upload_validation.py"), 16),
        ...
        Suite("server-campaign-native-developer-bridge", "server tests/test_campaign_native_developer_bridge.py", "pytest", SERVER,
              _py_pytest("tests/test_campaign_native_developer_bridge.py"), 40),
        Suite("server-campaign-product-execution", "server tests/test_campaign_product_execution.py", "pytest", SERVER,
              _py_pytest("tests/test_campaign_product_execution.py"), 30),
        Suite("server-campaign-release-service", "server tests/test_campaign_release_service.py", "pytest", SERVER,
              _py_pytest("tests/test_campaign_release_service.py"), 3),
        Suite("server-cat-oracle", "server tests/test_cat_oracle.py", "pytest", SERVER,
              _py_pytest("tests/test_cat_oracle.py"), 17),
        Suite("server-change-classifier", "server tests/test_change_classifier.py", "pytest", SERVER,
        ...
        Suite("server-completion-broker-file-route", "server tests/test_completion_broker_file_route.py", "pytest", SERVER,
              _py_pytest("tests/test_completion_broker_file_route.py"), 38),
        Suite("server-conversation-fence", "server tests/test_conversation_fence.py", "pytest", SERVER,
              _py_pytest("tests/test_conversation_fence.py"), 2),
        Suite("server-conversation-telemetry", "server tests/test_conversation_telemetry.py", "pytest", SERVER,
              _py_pytest("tests/test_conversation_telemetry.py"), 15),
        Suite("server-converse-registry", "server tests/test_converse_registry.py", "pytest", SERVER,
              _py_pytest("tests/test_converse_registry.py"), 12),
        Suite("server-deployment-identity-live", "server tests/test_deployment_identity_live.py", "pytest", SERVER,
              _py_pytest("tests/test_deployment_identity_live.py"), 59),
        Suite("server-developer-jobs-transport", "server tests/test_developer_jobs_transport.py", "pytest", SERVER,
              _py_pytest("tests/test_developer_jobs_transport.py"), 36),
        Suite("server-drawing-authority-cutover-marker", "server tests/test_drawing_authority_cutover_marker.py", "pytest", SERVER,
              _py_pytest("tests/test_drawing_authority_cutover_marker.py"), 3),
        Suite("server-drawing-identity", "server tests/test_drawing_identity.py", "pytest", SERVER,
              _py_pytest("tests/test_drawing_identity.py"), 4),
        ...
        Suite("server-error-guidance-contract", "server tests/test_error_guidance_contract.py", "pytest", SERVER,
              _py_pytest("tests/test_error_guidance_contract.py"), 2),
        Suite("server-glug-adoption", "server tests/test_glug_adoption.py", "pytest", SERVER,
              _py_pytest("tests/test_glug_adoption.py"), 20),
        Suite("server-glug-executor", "server tests/test_glug_executor.py", "pytest", SERVER,
              _py_pytest("tests/test_glug_executor.py"), 28),
        Suite("server-glug-jobs", "server tests/test_glug_jobs.py", "pytest", SERVER,
              _py_pytest("tests/test_glug_jobs.py"), 6),
        Suite("server-glug-live-adapters", "server tests/test_glug_live_adapters.py", "pytest", SERVER,
              _py_pytest("tests/test_glug_live_adapters.py"), 6),
        Suite("server-glug-routes", "server tests/test_glug_routes.py", "pytest", SERVER,
              _py_pytest("tests/test_glug_routes.py"), 12),
        Suite("server-image-turns", "server tests/test_image_turns.py", "pytest", SERVER,
              _py_pytest("tests/test_image_turns.py"), 15),
        Suite("server-instant-artifact-registry", "server tests/test_instant_artifact_registry.py", "pytest", SERVER,
              _py_pytest("tests/test_instant_artifact_registry.py"), 5),
        Suite("server-instant-session-wiring", "server tests/test_instant_session_wiring.py", "pytest", SERVER,
              _py_pytest("tests/test_instant_session_wiring.py"), 11),
        Suite("server-ios-ship-callback-listener", "server tests/test_ios_ship_callback_listener.py", "pytest", SERVER,
              _py_pytest("tests/test_ios_ship_callback_listener.py"), 3),
        Suite("server-ios-ship-provider", "server tests/test_ios_ship_provider.py", "pytest", SERVER,
              _py_pytest("tests/test_ios_ship_provider.py"), 41),
        Suite("server-ios-ship-router", "server tests/test_ios_ship_router.py", "pytest", SERVER,
              _py_pytest("tests/test_ios_ship_router.py"), 18),
        Suite("server-ios-surface-bridge", "server tests/test_ios_surface_bridge.py", "pytest", SERVER,
              _py_pytest("tests/test_ios_surface_bridge.py"), 32),
        Suite("server-ios-surface-contract", "server tests/test_ios_surface_contract.py", "pytest", SERVER,
              _py_pytest("tests/test_ios_surface_contract.py"), 41),
        Suite("server-ios-surface-e2e-harness", "server tests/test_ios_surface_e2e_harness.py", "pytest", SERVER,
              _py_pytest("tests/test_ios_surface_e2e_harness.py"), 5),
        Suite("server-mcp-gateway-telemetry", "server tests/test_mcp_gateway_telemetry.py", "pytest", SERVER,
              _py_pytest("tests/test_mcp_gateway_telemetry.py"), 20),
        Suite("server-mcp-status", "server tests/test_mcp_status.py", "pytest", SERVER,
              _py_pytest("tests/test_mcp_status.py"), 4),
        Suite("server-mcp-tool-projection", "server tests/test_mcp_tool_projection.py", "pytest", SERVER,
              _py_pytest("tests/test_mcp_tool_projection.py"), 6),
        Suite("server-multi-claude-grants", "server tests/test_multi_claude_grants.py", "pytest", SERVER,
              _py_pytest("tests/test_multi_claude_grants.py"), 1),
        Suite("server-plan-first", "server tests/test_plan_first.py", "pytest", SERVER,
              _py_pytest("tests/test_plan_first.py"), 3),
        Suite("server-plan-job-spine", "server tests/test_plan_job_spine.py", "pytest", SERVER,
              _py_pytest("tests/test_plan_job_spine.py"), 6),
        Suite("server-project-repository-edit-contract-freeze", "server tests/test_project_repository_edit_contract_freeze.py", "pytest", SERVER,
              _py_pytest("tests/test_project_repository_edit_contract_freeze.py"), 31),
        Suite("server-project-repository-edit-primitives", "server tests/test_project_repository_edit_primitives.py", "pytest", SERVER,
              _py_pytest("tests/test_project_repository_edit_primitives.py"), 33),
        Suite("server-project-repository-edit-router", "server tests/test_project_repository_edit_router.py", "pytest", SERVER,
              _py_pytest("tests/test_project_repository_edit_router.py"), 18),
        Suite("server-project-repository-edit-state", "server tests/test_project_repository_edit_state.py", "pytest", SERVER,
              _py_pytest("tests/test_project_repository_edit_state.py"), 7),
        Suite("server-project-session-consumers", "server tests/test_project_session_consumers.py", "pytest", SERVER,
              _py_pytest("tests/test_project_session_consumers.py"), 6),
        Suite("server-project-session-queue-recovery", "server tests/test_project_session_queue_recovery.py", "pytest", SERVER,
              _py_pytest("tests/test_project_session_queue_recovery.py"), 3),
        Suite("server-project-session-routes", "server tests/test_project_session_routes.py", "pytest", SERVER,
              _py_pytest("tests/test_project_session_routes.py"), 10),
        Suite("server-publication-requests", "server tests/test_publication_requests.py", "pytest", SERVER,
              _py_pytest("tests/test_publication_requests.py"), 16),
        Suite("server-question-required", "server tests/test_question_required.py", "pytest", SERVER,
              _py_pytest("tests/test_question_required.py"), 1),
        Suite("server-receipts-endpoint", "server tests/test_receipts_endpoint.py", "pytest", SERVER,
              _py_pytest("tests/test_receipts_endpoint.py"), 96),
        Suite("server-reconcile-authority-incremental", "server tests/test_reconcile_authority_incremental.py", "pytest", SERVER,
              _py_pytest("tests/test_reconcile_authority_incremental.py"), 14),
        Suite("server-reconcile-authority-source-schema", "server tests/test_reconcile_authority_source_schema.py", "pytest", SERVER,
              _py_pytest("tests/test_reconcile_authority_source_schema.py"), 7),
        Suite("server-request-journal", "server tests/test_request_journal.py", "pytest", SERVER,
              _py_pytest("tests/test_request_journal.py"), 22),
        Suite("server-roles", "server tests/test_roles.py", "pytest", SERVER,
        ...
        Suite("server-swallowed-failures", "server tests/test_swallowed_failures.py", "pytest", SERVER,
              _py_pytest("tests/test_swallowed_failures.py"), 27),
        Suite("server-tab-close-reap", "server tests/test_tab_close_reap.py", "pytest", SERVER,
              _py_pytest("tests/test_tab_close_reap.py"), 50),
        Suite("server-telemetry-sink-firehose", "server tests/test_telemetry_sink_firehose.py", "pytest", SERVER,
              _py_pytest("tests/test_telemetry_sink_firehose.py"), 33),
        Suite("server-template-clone", "server tests/test_template_clone.py", "pytest", SERVER,
              _py_pytest("tests/test_template_clone.py"), 20),
        Suite("server-template-e2e", "server tests/test_template_e2e.py", "pytest", SERVER,
              _py_pytest("tests/test_template_e2e.py"), 7),
        Suite("server-template-fence", "server tests/test_template_fence.py", "pytest", SERVER,
              _py_pytest("tests/test_template_fence.py"), 9),
        Suite("server-template-pinning", "server tests/test_template_pinning.py", "pytest", SERVER,
              _py_pytest("tests/test_template_pinning.py"), 25),
        Suite("server-template-roles-read", "server tests/test_template_roles_read.py", "pytest", SERVER,
              _py_pytest("tests/test_template_roles_read.py"), 17),
        Suite("server-template-roles-revocation", "server tests/test_template_roles_revocation.py", "pytest", SERVER,
              _py_pytest("tests/test_template_roles_revocation.py"), 17),
        Suite("server-template-roles-write", "server tests/test_template_roles_write.py", "pytest", SERVER,
              _py_pytest("tests/test_template_roles_write.py"), 35),
        Suite("server-template-undo", "server tests/test_template_undo.py", "pytest", SERVER,
              _py_pytest("tests/test_template_undo.py"), 15),
        Suite("server-template-write", "server tests/test_template_write.py", "pytest", SERVER,
              _py_pytest("tests/test_template_write.py"), 41),
        Suite("server-tool-publication-policy", "server tests/test_tool_publication_policy.py", "pytest", SERVER,
