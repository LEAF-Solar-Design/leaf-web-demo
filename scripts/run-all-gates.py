...
def build_suites() -> List[Suite]:
    ...
    suites: List[Suite] = [
        ...
        # exact collected count on every runner: 19 (11 + three zone-assign, three frame-park and two sizer cases,
        # G36 addendum),
        # 10 + 5 parametrizations = 15, 8 + 8 = 16.
        Suite("server-solar-batch2-simple", "server tests/test_solar_batch2_simple.py",
              "pytest", SERVER, _py_pytest("tests/test_solar_batch2_simple.py"), 19),
        ...
        # the file, so each floor is the exact collected count: 8 (with z2, z3, f2 and k1), 5 and 3.
